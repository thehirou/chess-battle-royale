...
// Create camera
var creatX=o_spawn.x-240 //Why these numbers? I don't fucking know
var creatY=o_spawn.y-100

camera = camera_create_view(creatX, creatY, RES_W, RES_H);
...
//FIrst init values of W and H
initWidth=camera_get_view_width(camera)
initHeight=camera_get_view_height(camera)
