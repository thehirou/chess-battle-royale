...
if (mouse_check_button(mb_middle)) {
	...
	var targetX = o_followcamera.x - camW/2;
	var targetY = o_followcamera.y - camH/2;
...
if keyboard_check_pressed(ord("Z")){camW=initWidth; camH=initHeight;}
...
camera_set_view_pos(camera, camX+o_screenshake._xval, camY+o_screenshake._yval);
